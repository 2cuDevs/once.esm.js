...
// ONCE 4.3.0 origin/tmp/stable1.0.5_brokenclient
            ...
            case Once.MODE_I_FRAME:
                return [
                    [
                        ...
                        "/EAMD.ucp/Components/tla/EAMD/UcpComponentSupport/4.3.0/UcpComponentSupport.component.xml",
                        "/EAMD.ucp/Components/tla/EAM/layer1/Thinglish/Once/4.3.0/src/js/DragDropTouch.js",
                    ],
                    // Load all Components who are UcpComponents
                    [
                        "/EAMD.ucp/Components/tla/EAM/layer2/RESTClient/4.3.0/RESTClient.component.xml",
            ...
            case Once.MODE_NODE_SERVER:
                return [
                    [
                        ...
                        "/EAMD.ucp/Components/tla/EAM/layer2/RESTClient/4.3.0/RESTClient.component.xml",
                        "/EAMD.ucp/Components/org/Keycloak/KeycloakSessionManager/4.3.0/KeycloakSessionManager.component.xml",
                        "/EAMD.ucp/Components/tla/EAM/layer3/lang/MultilanguageController/4.3.0/MultilanguageController.component.xml",
                    ]
                ];
        }
    ...
    */
        ...
        ONCE.global.FileScriptClient = Namespace.declare("tla.EAM.layer2.OnceServices",
            class FileScriptClient extends Thing {
                ...
                async load(ior) {
                    ...
                    let filename = ONCE.ENV.ONCE_REPO_PREFIX + ior.pathName;
    ...
    startReverseProxy() {
        try {
            ...
            ONCE.reverseProxy.listen(rport, rhost, () => {
    ...
    startCORSAnywhereproxy() {
        try {
            ...
            Once.corsAnywhere.createServer({
